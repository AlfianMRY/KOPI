    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="card card-success">
          ...
          <div class="card-body">
            <form action="{{ route('mtingkat.update',$t->id) }}" method="post">
              @csrf
              @method('put')
              <div class="row">
                  <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama_tingkat" value="{{ $t->nama_tingkat }}" required>
                      </div>
                  </div>
                  <div class="col-md-6">
                      <div class="form-group">
                        <label>Kode Tingkat</label>
                        <input type="text" class="form-control" name="kode_tingkat" value="{{ $t->kode_tingkat }}" required>
                      </div>
                  </div>
              </div>
    ...
    <!-- /.modal-dialog -->
            ...
            <div class="modal fade" id="modal-sm{{ $t->id }}">
                ...
                <div class="modal-content">
                    ...
                    <h4 class="modal-title">{{ $t->nama_tingkat }}</h4>
                    ...
                    <form action="{{ route('mtingkat.destroy',$t->id) }}" method="post">
                    @csrf
                    @method('delete')
                        <p>Yakin Hapus Data {{ $t->kode_tingkat }} ?</p>
                    </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content">
        ...
        <div class="card card-success">
          ...
          <div class="card-body">
            <form action="{{ route('mtingkat.store') }}" method="post">
              @csrf
              <div class="row">
                  <div class="col-md-6">
                      <div class="form-group">
                        <label>Nama Tingkat</label>
                        <input type="text" class="form-control" name="nama_tingkat" placeholder="Enter ..." required>
                      </div>
                  </div>
                  <div class="col-md-6">
                      <div class="form-group">
                        <label>Kode Tingkat</label>
                        <input type="text" class="form-control" name="kode_tingkat" placeholder="Enter ..." required>
                      </div>
                  </div>
              </div>
